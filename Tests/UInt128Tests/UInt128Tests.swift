...
class BaseTypeTests: XCTestCase {
  ...
  func testDesignatedInitializerProperlySetsInternalValue() {
    var tests = [
      (
        input: (upperBits: UInt64.min, lowerBits: UInt64.min),
    ...
    tests.forEach { test in
      let result = UInt128(
        upperBits: test.input.upperBits,
...
class FixedWidthIntegerTests: XCTestCase {
  ...
  func endianTests() -> [(input: UInt128, byteSwapped: UInt128)] {
    ...
    tests.append(
      (
        input: UInt128(1),
        byteSwapped: UInt128(upperBits: 72_057_594_037_927_936, lowerBits: 0)
      ))
    tests.append(
      (
        input: UInt128(
          upperBits: 17_434_549_027_881_090_559, lowerBits: 18_373_836_492_640_810_226),
        byteSwapped: UInt128(
          upperBits: 17_506_889_200_551_263_486, lowerBits: 18_446_176_699_804_939_249)
      ))
    return tests
  }
  ...
  func testSubtractingReportingOverflow() {
    ...
    tests.append(
      (
        ...
        difference: (
          partialValue: UInt128(upperBits: UInt64.max, lowerBits: (UInt64.max >> 1) << 1),
          overflow: false
        )
      ))
  ...
  func testMultipliedReportingOverflow() {
    ...
    tests.append(
      (
        ...
        product: (
          partialValue: UInt128(upperBits: (UInt64.max >> 1) << 1, lowerBits: 1), overflow: false
        )
      ))
    // UInt128.max * 0 = 0
    tests.append(
  ...
  func testMultipliedFullWidth() {
    ...
    tests.append(
      (
        multiplier: UInt128(1), multiplicator: UInt128(1),
  ...
  func divisionTests() -> [(
    dividend: UInt128, divisor: UInt128, quotient: (partialValue: UInt128, overflow: Bool),
    remainder: (partialValue: UInt128, overflow: Bool)
  )] {
  ...
  func testBitFromDoubleWidth() {
    var tests = [
      (
        input: (high: UInt128(1), low: UInt128.min),
    ...
    tests.append(
      (
        input: (high: UInt128(2), low: UInt128.min),
    ...
    tests.append(
      (
        input: (high: UInt128.min, low: UInt128(2)),
        position: UInt128.min, result: UInt128.min
      ))
    tests.append(
      (
  ...
  func testDividingFullWidth() throws {
    ...
    var tests = [
      (
        dividend: (high: UInt128.min, low: UInt128(1)),
        divisor: UInt128(1),
    ...
    tests.append(
      (
        dividend: (high: UInt128(1), low: UInt128.min),
        divisor: UInt128(1),
    ...
    tests.append(
      (
        ...
        divisor: UInt128(2),
        result: (
          quotient: try XCTUnwrap(UInt128("170141183460469231731687303715884105728")),
...
class BinaryIntegerTests: XCTestCase {
  ...
  func testInitFloatingPoint() {
    ...
    #else
      var tests = [(input: 0.0, result: UInt128())]
      tests.append((input: 0.1, result: UInt128()))
      tests.append((input: 1.0, result: UInt128(1)))
      tests.append((input: Double(UInt32.max), result: UInt128(UInt32.max)))
    #endif
  ...
  func test_word() {
    ...
    testResult.words.forEach { (currentWord) in
      if UInt.bitWidth == 64 {
        XCTAssertEqual(currentWord, 4_294_967_297)
      }
    }
  }

  func divisionTests() -> [(
    dividend: UInt128, divisor: UInt128, quotient: UInt128, remainder: UInt128
  )] {
    // 0 / 1 = 0, remainder 0
    var tests = [
      (
  ...
  func testBooleanAndEqualOperator() {
    ...
    tests.append(
      (
        lhs: UInt128(upperBits: 17_434_549_027_881_090_559, lowerBits: 18_373_836_492_640_810_226),
        rhs: UInt128(upperBits: 17_506_889_200_551_263_486, lowerBits: 18_446_176_699_804_939_249),
        result: UInt128(
          upperBits: 17_361_645_879_185_571_070, lowerBits: 18_373_836_492_506_460_400)
      ))
  ...
  func testBooleanOrEqualOperator() {
    ...
    tests.append(
      (
        ...
        rhs: UInt128(upperBits: 17_506_889_200_551_263_486, lowerBits: 18_446_176_699_804_939_249),
        result: UInt128(
          upperBits: 17_579_792_349_246_782_975, lowerBits: 18_446_176_699_939_289_075)
      ))
    tests.append((lhs: UInt128.max, rhs: UInt128.max, result: UInt128.max))
  ...
  func testBooleanXorEqualOperator() {
    ...
    tests.append(
      (
        lhs: UInt128(upperBits: 17_434_549_027_881_090_559, lowerBits: 18_373_836_492_640_810_226),
        rhs: UInt128(upperBits: 17_506_889_200_551_263_486, lowerBits: 18_446_176_699_804_939_249),
        result: UInt128(upperBits: 218_146_470_061_211_905, lowerBits: 72_340_207_432_828_675)
      ))
